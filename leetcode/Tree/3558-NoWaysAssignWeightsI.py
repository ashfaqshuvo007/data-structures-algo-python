...
Initially, all edges have a weight of 0. You must assign each edge 
a weight of either 1 or 2.
...
assign edge weights in the path from node 1 to x such that its total cost is odd.
